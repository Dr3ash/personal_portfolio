...
const sendEmail = (e) =>{
	...
	emailjs.sendForm('service_2y6um3b', 'template_7spgzcm', '#contact-form', 'JmOmmx_relH_XqjXs')
	.then(() =>{
		// Show sent message
...
const scrollUp = () =>{
	...
	// Show the scroll up arrow when the scroll is higher than 350 viewport height
